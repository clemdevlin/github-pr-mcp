/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6376be4a74fa0ea30feb7a5e5ed11d90)
// Runtime types generated with workerd@1.20260625.1 2026-06-20 nodejs_compat
interface __BaseEnv_Env {
	ALLOWED_REPOS: "clemdevlin/file-router,clemdevlin/github-pr-mcp";
	GITHUB_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_REPOS" | "GITHUB_TOKEN">> {}
}
